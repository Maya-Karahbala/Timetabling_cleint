...
class ConflictsPage2 extends Component {
  ...
  render() {
    console.log("this.depClassroomConflicts",this.state,this.allConflicts)
                      ...
                      <CardText>
                        ...
                        <pre>
                          Bölüm adı{"          :"}
                          {
                            ...
                            filter(dep=> dep.id==this.state.course1.Opened_course.Department_course
                              .departmentId)[0]
                            .name
                          }{" "}
                        </pre>
                    ...
                    <Card body>
                      ...
                      <CardText>
                        ...
                        <pre>
                          Bölüm adı{"          :"}
                          {
                            this.props.departments.filter(dep=> dep.id==this.state.course2.Opened_course.Department_course
                              .departmentId)[0].name
                          }{" "}
                        </pre>
                      </CardText>
...
export default connect(mapStateToProps, mapDispatchToProps)(ConflictsPage2);
